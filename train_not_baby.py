import argparse
import shutil
from utils.learning.train_part_not_baby import train
...
def parse():
    ...
    parser.add_argument('-be', '--bn-epochs', type=int, default=2, help='Number of epochs for BN stabilization')
    ...
    parser.add_argument('--if-val', '--no-if-val', default=True, action=argparse.BooleanOptionalAction, help='If validation is needed')
